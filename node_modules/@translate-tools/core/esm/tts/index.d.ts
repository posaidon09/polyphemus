 ...
 */
export declare type TTSAudioBuffer = {
    /**
     * Audio mimetype
     */
    type: string;
...
export interface TTSProviderProps {
     ...
     */
    getAudioBuffer(text: string, language: string, options?: Record<string, string>): Promise<TTSAudioBuffer>;
}
/**
 ...
 */
export declare type TTSProvider = TTSProviderStaticProps & {
