 ...
 */
export declare type langCode = string;
/**
 * @deprecated this type too strict, use `string` instead
 */
export declare type langCodeWithAuto = string;
export interface TranslatorInstanceMembers {
     ...
     */
    translateBatch(text: string[], langFrom: langCodeWithAuto, langTo: langCode): Promise<Array<string | null>>;
    /**
 ...
 */
export interface TranslatorClass<InstanceProps extends TranslatorInstanceMembers = TranslatorInstanceMembers> extends TranslatorStaticMembers {
